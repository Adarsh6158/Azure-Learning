...
The **cloud** is a network of powerful computers (servers) located in **data centers around the world** that you can use through the **internet**.

Instead of storing files or running applications on your own computer or server, you use **remote servers** provided by companies like **Microsoft Azure, AWS, or Google Cloud**.

## Example
When you upload photos to **Google Drive** or **OneDrive**, the files are **not stored on your laptop** — they are stored on **cloud servers**.
...
You **rent computing power when you need it** instead of buying expensive hardware.

## Example
Instead of buying a server for your **Spring Boot application**, you deploy it on **Azure App Service**.
...
## Public Cloud
In a **public cloud**, the cloud provider **owns and manages the infrastructure**, and **multiple customers share it**.
...
Companies keep **sensitive data in the private cloud** and use the **public cloud for scaling**.
...
**Elasticity** is the ability of **cloud systems** to **automatically increase or decrease computing resources** based on **demand**.
...
**Agility** refers to the ability to **quickly create, configure, and deploy cloud resources**.
...
**High availability** ensures that **applications remain operational and accessible** even when **some components fail**.
...
**Fault tolerance** is the ability of a **system** to **continue functioning** even when **hardware or software failures occur**.
